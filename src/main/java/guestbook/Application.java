...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "hacker@example.com", "first!!!"), //
					new GuestbookEntry("Arni", "arni@example.com", "Hasta la vista, baby"), //
					new GuestbookEntry("Duke Nukem", "duke@example.com",
							"It's time to kick ass and chew bubble gum. And I'm all out of gum."), //
					new GuestbookEntry("Gump1337", "gump@example.com",
